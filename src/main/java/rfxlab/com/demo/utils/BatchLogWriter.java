...
public class BatchLogWriter {
    ...
    static final boolean ENABLED_WRITE_RAW_LOG = "true"
	    .equalsIgnoreCase(WORKER_CONFIGS.getCustomConfig("enableWriteRawLog").trim());
     ...
     * RawLogUtil.writeRawLog(DateTimeUtil.currentUnixTimestamp(), 1, valueList);
     * <br>
     * 
